...
namespace csis3700 {
  ...
  public:
     ...
     */
    rectangle(Vector2 corner, float width, float height);
     ...
     */
    rectangle(Vector2 upper_left_corner, Vector2 lower_right_corner);
     ...
     */
    Vector2 upper_left_corner() const;

    /**
     * Return my lower right corner
     */
    Vector2 lower_right_corner() const;
