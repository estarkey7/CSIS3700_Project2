...
namespace csis3700
{
	...
	{
	public:
		enemy_sprite(string name_in, float initial_x, float initial_y, float sx_in, float sy_in, ALLEGRO_BITMAP *image, float move_speed_in = 10, bool can_jump = false, float jump_amount_in = 60, int damage_in = 10);
